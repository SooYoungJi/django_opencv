...
def simple_upload(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # fs.delete(filename) # 파일을 지우고자 할 때
...
def detect_face(request):
    if request.method == 'POST' :
        ...
        # row = ImageUploadModel(description=description, document=uploaded_image)
        # row.save()
        ...
        if form.is_valid():
            ...
            # '.' + '/media/' + 'images/2021/10/29/ses_XQAftn4.jpg'
            # './media/images/2021/10/29/ses_XQAftn4.jpg'
            # pd.read_excel('./media/data_main.xlsx')
            # pd.read_excel('./data_upload/data_main.xlsx')
